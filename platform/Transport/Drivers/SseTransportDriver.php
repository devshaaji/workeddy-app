...
final class SseTransportDriver implements TransportDriverInterface
{
    public function send(TransportMessage $message, TransportDestination $destination): TransportResult
    {
        return TransportResult::failure('SSE transport adapter is registered but no realtime server adapter is configured.', true);
    }
