...
final class ResolveNotificationChannels implements ChannelResolverInterface
{
    ...
    public function __construct()
    {
        $this->rules = [
            ...
            'payment_receipt' => [NotificationChannel::EMAIL, NotificationChannel::IN_APP, NotificationChannel::WHATSAPP],
            'invoice_created' => [NotificationChannel::EMAIL, NotificationChannel::IN_APP, NotificationChannel::WHATSAPP],
            'subscription_expired' => [NotificationChannel::EMAIL, NotificationChannel::IN_APP, NotificationChannel::WHATSAPP, NotificationChannel::SMS],
            'customer_suspended' => [NotificationChannel::EMAIL, NotificationChannel::IN_APP, NotificationChannel::SMS, NotificationChannel::WHATSAPP],
            'subscription_activated' => [NotificationChannel::EMAIL, NotificationChannel::IN_APP, NotificationChannel::WHATSAPP],
            'support_ticket_created' => [NotificationChannel::EMAIL, NotificationChannel::IN_APP],
