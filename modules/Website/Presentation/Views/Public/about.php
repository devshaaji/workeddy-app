    ...
    <div class="row align-items-center g-5">
      <div class="col-lg-7">
        <div class="about-title-container">
          ...
          <p class="fs-5 text-muted mb-0 page-lede">We help organizations see how work tasks affect the body, identify ergonomic and heat-related risks, assign corrective actions, verify follow-through, and document measurable improvement while protecting worker dignity and privacy.</p>
        </div>
      </div>
      <div class="col-lg-5">
        <div class="about-signal-panel">
          <div>
            ...
            <strong>Identify strain. Fix the task. Verify improvement. Protect the worker.</strong>
          </div>
...
<main>
    ...
    <div class="container">
      <div class="row g-5 align-items-start">
        ...
        <div class="col-lg-6">
          ...
          <p class="text-muted mb-0">WorkEddy fills that gap by bringing task video, ergonomic risk logic, body-region insights, worker discomfort reporting, corrective action tracking, before-and-after comparisons, privacy controls, and de-identified reporting into a single prevention system.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="site-section bg-white">
    <div class="container">
      ...
      <div class="row g-4">
        <?php foreach ([
          ['icon' => 'bi-activity', 'title' => 'Identify risk earlier', 'copy' => 'Surface task-level ergonomic and heat stress risks before pain becomes routine.'],
