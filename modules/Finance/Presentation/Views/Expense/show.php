...
$pageActions = [
    ['label' => 'Back to expenses', 'url' => '/finance/expenses', 'class' => 'btn btn-white'],
    ['label' => 'Edit', 'url' => '/finance/expenses/' . rawurlencode((string) ($record['uuid'] ?? '')) . '/edit', 'class' => 'btn btn-primary'],
];
...
<?php else: ?>
<div class="card" data-finance-page="expense-detail" data-uuid="<?= htmlspecialchars((string) $record['uuid'], ENT_QUOTES, 'UTF-8') ?>">
    ...
    <div class="card-footer d-flex justify-content-end py-2">
        <button class="btn btn-outline-danger" type="button" data-finance-archive="expense" data-uuid="<?= htmlspecialchars((string) $record['uuid'], ENT_QUOTES, 'UTF-8') ?>">
