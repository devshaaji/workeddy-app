...
final class IamRoleAssignedEvent implements DomainEvent
{
    public function __construct(
        public readonly int|string $actorId,
        public readonly int|string $userId,
        public readonly string $userUuid,
        public readonly string $beforeRoleSlug,
        public readonly string $afterRoleSlug,
    ) {}
    ...
    public function envelope(): EventEnvelope
    {
        return new EventEnvelope(
            ...
            payload: [
                ...
                'before_role_slug' => $this->beforeRoleSlug,
                'after_role_slug' => $this->afterRoleSlug,
            ],
            metadata: []
        );
    }
